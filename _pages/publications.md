...
<p style="margin:0.3rem 0 1.5rem 0;"><a href="{{ '/assets/pdf/bertoli_jmp.pdf?v=25' | relative_url }}" target="_blank" rel="noopener" style="display:inline-block; padding:3px 12px; border:1px solid var(--global-divider-color,#e8e8e8); border-radius:6px; font-size:0.8rem; text-decoration:none; color:inherit;">📄&nbsp;Download paper</a></p>
